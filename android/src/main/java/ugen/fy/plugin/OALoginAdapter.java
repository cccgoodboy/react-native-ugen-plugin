...
public class OALoginAdapter implements ILoginAdapter {
    ...
    private InitResultCallback callback;


    /* --         Method         --*/
    public OALoginAdapter(Context context, InitResultCallback callback) {
        this(context,callback, false);
    }

    public OALoginAdapter(Context context, InitResultCallback callback, boolean debug) {
...
//                    Log.i("OpenAccountSDK", "登录成功");
//                }
//
//                @Override
//                public void onFailure(int i, String s) {
//                    Log.i("OpenAccountSDK", "登录失败");
//
//                }
//            });
    ...
    public boolean isLogin() {
        ...
        return session != null && session.isLogin() && !isSessionExpired();
    }
